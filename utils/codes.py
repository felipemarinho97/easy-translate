languages = [
    ...
    {"code": "en-AU", "name": "English (Australia)", "flag": "🇦🇺", "englishName": "English"},
    {"code": "en-CA", "name": "English (Canada)", "flag": "🇨🇦", "englishName": "English"},
    {"code": "en-GB", "name": "English (United Kingdom)", "flag": "🇬🇧", "englishName": "English"},
    ...
    {"code": "fr-FR", "name": "Français (France)", "flag": "🇫🇷", "englishName": "French"},
    {"code": "fr-CA", "name": "Français (Canada)", "flag": "🇨🇦", "englishName": "French"},
    ...
    {"code": "ms-MY", "name": "Bahasa Melayu (Malaysia)", "flag": "🇲🇾", "englishName": "Malay (Malaysia)"},
    ...
    {"code": "pt-BR", "name": "Português (Brasil)", "flag": "🇧🇷", "englishName": "Portuguese (Brazil)"},
    {"code": "pt-PT", "name": "Português (Portugal)", "flag": "🇵🇹", "englishName": "Portuguese (Portugal)"},
    ...
    {"code": "uz", "name": "O'zbekcha", "flag": "🇺🇿", "englishName": "Uzbek"},
    {"code": "vi", "name": "Tiếng Việt", "flag": "🇻🇳", "englishName": "Vietnamese"},
    {"code": "cy", "name": "Cymraeg", "flag": "🏴", "englishName": "Welsh"},
    {"code": "xh", "name": "IsiXhosa", "flag": "🇿🇦", "englishName": "Xhosa"},
    {"code": "zu", "name": "IsiZulu", "flag": "🇿🇦", "englishName": "Zulu"},
    {"code": "yo", "name": "Yorùbá", "flag": "🇳🇬", "englishName": "Yoruba"},
    {"code": "es-ES", "name": "Español (España)", "flag": "🇪🇸", "englishName": "Spanish (Spain)"},
    {"code": "es-MX", "name": "Español (México)", "flag": "🇲🇽", "englishName": "Spanish (Mexico)"},
    {"code": "es", "name": "Español", "flag": "🇪🇸", "englishName": "Spanish"},
    {"code": "fr", "name": "Français", "flag": "🇫🇷", "englishName": "French"},
    {"code": "zh-CN", "name": "中文 (简体)", "flag": "🇨🇳", "englishName": "Chinese (Simplified)"},
    {"code": "zh-TW", "name": "中文 (繁體)", "flag": "🇹🇼", "englishName": "Chinese (Traditional)"},
